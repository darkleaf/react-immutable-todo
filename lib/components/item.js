...
import {ToggleItem, DeleteItem} from '../transitions/items';
...
export default React.createClass({
  ...
  render() {
    let toggleButton = <tb.Button onClick={this.handleToggle}>
      <tb.Glyphicon glyph={this.props.item.state == 'done' ? 'ok' : 'unchecked'} />
    </tb.Button>;
    let deleteButton = <tb.Button onClick={this.handleDelete}>
